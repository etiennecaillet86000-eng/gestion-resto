...
import type { Result as _Result, VenteRecette as _VenteRecette } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createVente(arg0: string, arg1: string, arg2: number): Promise<Result> {
        if (this.processError) {
            try {
