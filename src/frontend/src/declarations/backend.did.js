...
export const VenteRecette = IDL.Record({
  ...
  'recetteId' : IDL.Text,
  'date' : IDL.Text,
  'caTtcCapture' : IDL.Float64,
  'quantite' : IDL.Float64,
  'coutMatiereTotalCapture' : IDL.Float64,
});
export const Result = IDL.Variant({ 'ok' : VenteRecette, 'err' : IDL.Text });
...
export const idlService = IDL.Service({
  ...
  'createVente' : IDL.Func([IDL.Text, IDL.Text, IDL.Float64], [Result], []),
...
export const idlFactory = ({ IDL }) => {
  ...
  const Result = IDL.Variant({ 'ok' : VenteRecette, 'err' : IDL.Text });
